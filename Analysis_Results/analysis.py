...
def analyze_data():
    baseline_df = load_and_prepare_data('SGSim/C0_Baseline/Baseline.csv')
    fdi_df = load_and_prepare_data('SGSim/C1_FDI/FDI.csv')
    delay_df = load_and_prepare_data('SGSim/C2_Delay/C2_Delay.csv')

...
# This script finds all .pcapng files in the C2_Delay directory,
# converts them to CSV format using tshark, and merges them into a
# single CSV file named C2_Delay.csv.

# Define the base directory where pcapng files are located
BASE_DIR="/home/luk3/Desktop/SGSim/C2_Delay/"
OUTPUT_CSV="/home/luk3/Desktop/SGSim/C2_Delay/C2_Delay.csv"  # Define the output CSV file name

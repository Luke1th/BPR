...
# This script finds all .pcapng files for individual runs and export them into a .CSV
#following the same naming convention
# converts them to CSV format using tshark


# Define the base directory where pcapng files are located
BASE_DIR="/home/luk3/Desktop/SGSim/C2_Delay/C2_Delay_30s_trial10"

# Define the output CSV file name
OUTPUT_CSV="/home/luk3/Desktop/SGSim/C2_Delay/C2_Delay_30s_trial10/trial10.csv"

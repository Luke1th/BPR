...
# This script finds all .pcapng files in the C1_FDI directory,
# converts them to CSV format using tshark, and merges them into a
# single CSV file named FDI.csv.

# Define the base directory where pcapng files are located
BASE_DIR="/home/luk3/Desktop/SGSim/C1_FDI/"

# Define the output CSV file name
OUTPUT_CSV="/home/luk3/Desktop/SGSim/C1_FDI/FDI.csv"
